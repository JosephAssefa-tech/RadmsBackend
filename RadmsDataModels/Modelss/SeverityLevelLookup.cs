...
namespace RadmsDataModels.Modelss
{
    ...
    public partial class SeverityLevelLookup
    {
        ...
        [StringLength(255)]
        public string? SeverityTypeAm { get; set; }
        [StringLength(255)]
        public string? SeverityTypeOr { get; set; }
        [StringLength(255)]
        public string? SeverityTypeTi { get; set; }
        [StringLength(255)]
        public string? SeverityTypeAf { get; set; }
        [StringLength(255)]
        public string? SeverityTypeSo { get; set; }
