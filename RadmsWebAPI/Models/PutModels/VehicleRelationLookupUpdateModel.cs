...
{
    public class VehicleRelationLookupUpdateModel
    {
        public VehicleRelationLookupUpdateModel()
        {
        ...
        public VehicleRelationLookupUpdateModel(VehicleRelationLookupEntity model)
        {
